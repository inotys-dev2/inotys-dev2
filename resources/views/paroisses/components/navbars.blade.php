    ...
    <ul class="navbar__list">
        ...
        <li class="navbar__item dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <ul class="dropdown__menu">
                ...
                <li>
                    <a href="{{ route('paroisses.demandes', ['uuid' => $paroisse->uuid]) }}" class="dropdown__item">
                        Les demandes
                    </a>
                </li>
            </ul>
        ...
        <!-- Menu déroulant : Gestion des paiements -->
        <li class="navbar__item dropdown" aria-haspopup="true" aria-expanded="false">
            <button class="dropdown__toggle">
            ...
            <ul class="dropdown__menu">
                <li>
                    <a href="{{ route('paroisses.paiement', ['uuid' => $paroisse->uuid]) }}" class="dropdown__item">
                        Paiement
                    </a>
                </li>
            </ul>
        ...
        <li class="navbar__item dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <ul class="dropdown__menu">
                <li>
                    <a href="{{ route('paroisses.parametre', ['uuid' => $paroisse->uuid]) }}" class="dropdown__item">
                        Paramètre
                    </a>
                </li>
                <li>
                    <a href="{{ route('paroisses.profile', ['uuid' => $paroisse->uuid]) }}" class="dropdown__item">
                        Profil
                    </a>
                </li>
            </ul>
